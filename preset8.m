...
valid_wave_direction_idx = valid_idx & ~strcmp(data.('waveMeanDirection_awc8'), 'NA');
valid_current_direction_idx = valid_idx & ~strcmp(data.('currentDirection_awc8'), 'NA');

filtered_data_wave = data(valid_wave_direction_idx, :);
filtered_data_current = data(valid_current_direction_idx, :);

filtered_waveMeanDirection_awc45 = str2double(filtered_data_wave.('waveMeanDirection_awc8'));
filtered_currentDirection_awc45 = str2double(filtered_data_current.('currentDirection_awc8'));
